...
$(document).on('click', '.remove3', function() {
    ...
    function gresetClass(object) {
        console.log(object.parent().find(".layer-3-b").attr('class'))
        console.log(object.find(".layer-3-b").attr('class'))
        
        i = 1
        
        object.find(".layer-3-b").each(function () {
...
$(document).on('click', '.remove4', function() {
    ...
    function hresetClass(object) {
        ...
        object.find(".layer-4-b").each(function () {
