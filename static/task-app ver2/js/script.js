...
$(document).on("click",".add-btn", function () {
    ...
    $('.layer-A').children('div').each(function(){
        $(this).addClass('a'+i);
        i++;
...
// layer-b
    ...
    $('.layer-B').children('div').each(function(){
        $(this).addClass('a'+i);
        i++;
...
function addclassNames(o){
    ...
    // 親クラス参照　クラスの末尾に、取得した親クラスの末尾のアルファベットを１つ下げたものを付与して１を足す
    ...
    console.log(o.parent().next("ul"))

    o.parent().next("ul").each(function(){
    ...
    object.each(function(){
        ...
        console.log(nextClassName)
        var className = nextClassName + i
        i++

        object.addClass(`${className}`)
        // parseInt(nextClassName) + parseInt(i);
        console.log(className)
    ...
    //     console.log(classNames)
    //     var className = classNames.split(' ').slice(-1)[0]
    //     var classNameNum = className.slice(1)[0]
    //     classNameNum = parseInt(classNameNum) + parseInt(i);
    //     i++
    ...
    //     // var nextClassNameNum = classNames.remove(classNames.split(' ').slice(-1)[0])
        
    //     // console.log(nextClassNameNum)

    //     object.remove(object.attr("class").split(' ').slice(0)[0])
    //     object.addClass(`${nextClassName}`+`${classNameNum}`);
